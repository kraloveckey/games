...
namespace _2048
{
    class Game
    {
        ...
        public void DrawGame(Graphics g)
        {
            ...
            DrawTextCenterX(g, "By kraloveckey", fFontS, new SolidBrush(Color.FromArgb(120, 110, 101)), 198, 552);
        }
        ...
        public void DrawAbout(Graphics g)
        {
            ...
            DrawTextCenterXWS(g, "Author: kraloveckey", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 250);
        }
